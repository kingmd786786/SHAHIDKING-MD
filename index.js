...
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
    if (config.SESSION_ID && config.SESSION_ID.trim() !== "") {
        const sessdata = config.SESSION_ID.replace("SHAHIDKING-MD~", '');
        try {
...
const port = process.env.PORT || 9090;
  ...
  let up = `*Hello there SHAHIDKING-MD User! \ud83d\udc4b\ud83c\udffb* \n\n> Simple , Straight Forward But Loaded With Features \ud83c\udf8a, Meet SHAHIDKING-MD WhatsApp Bot.\n\n *Thanks for using SHAHIDKING-MD \ud83d\udea9* \n\n> Join WhatsApp Channel :- ⤵️\n \nhttps://whatsapp.com/channel/0029Vb6GQ0sH5JM5NiaEaS22 \n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/kingmd786786/SHAHIDKING-MD\n\n> © 𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗 ❣️ \ud83d\udda4`;
    conn.sendMessage(conn.user.id, { image: { url: `https://i.ibb.co/0p9rhmgG/shaban-md.jpg` }, caption: up })
  }
  })
...
if (!isReact && config.CUSTOM_REACT === 'true') {
  ...
  app.get("/", (req, res) => {
  res.send("𝗦𝗛𝗔𝗛𝗜𝗗 𝗞𝗜𝗡𝗚-𝗠𝗗 STARTED ✅");
  });
